...
import vertexShaderSource from "../shader/4-2/main.vert";
import fragmentShaderSource from "../shader/4-2/main.frag";
  ...
  () => {
    ...
    window.addEventListener(
      ...
      (event) => {
        ...
        mousePosition[1] = event.clientY / window.innerHeight;
      },
      false
    );
